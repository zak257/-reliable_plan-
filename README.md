...
最新运行已完成 **中山站 8760 小时、2000 个规划场景与 10000 个独立验证场景**，见 [大样本结果报告](docs/zhongshan_large_validation_results.md)。方案为风电 700 kW、光伏 300 kW、柴油 600 kW、电池 1450 kWh、PCS 300 kW；成本 3,362,791.24 元/年，实际 gap **0.988921%**，达到设定的 1%。规划 EENS/CVaR 为 9.869889 / 197.397773 kWh，独立验证为 **12.508809 / 250.176188 kWh**，双约束均通过。每次求解时限设为 3600 秒，完整流程实际耗时 783.051 秒。44 项测试及 48 点穷举对照通过，报告包含全部 12000 个年度场景的损失和验证样本数变化图。
